    ...
    return (
        <>
            <motion.button
                ...
                className="fixed bottom-6 right-6 w-14 h-14 rounded-full text-white z-[200] flex items-center justify-center"
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed bottom-24 right-6 z-[200] flex flex-col"
                        style={{
